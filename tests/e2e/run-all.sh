...
mode classic
for t in e2e retiro-municipio ficha-municipio envio-oculto tiendas-ciudad disponibilidad envio-sin-was textos-tienda sucursal-por-defecto repro-backorder repro-switcher-loop; do
	run "$t"
done
mode blocks
run e2e-blocks
