...
node e2e.js                                  # 30 comprobaciones con Chromium (Playwright)
```
...
- Se usa un tema clásico (Twenty Twenty-One). Con temas de bloques el filtro de catálogo de Multi-Locations (`woocommerce_product_query`) no se ejecuta y la tienda sale vacía.
