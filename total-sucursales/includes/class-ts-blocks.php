	...
	public static function cart_data() {
		...
		foreach ( (array) ( $summary['packages'] ?? array() ) as $p ) {
			...
			$rows[] = array(
				...
				'distance_label'  => null === $p['distance_km'] ? '' : ts_format_km( $p['distance_km'] ),
		...
		return array(
			...
			'geo_button'    => TS_Settings::is_yes( 'checkout_geo_button' ),
			'show_info'     => TS_Settings::is_yes( 'show_distance_info' ),
			'packages'      => $rows,
			'i18n'          => array(
				'button'      => __( 'Usar mi ubicación para retiro en tienda', 'total-sucursales' ),
				'registered'  => __( 'Ubicación registrada', 'total-sucursales' ),
				'hint'        => __( 'Comparte tu posición para saber si puedes retirar en la sucursal más cercana.', 'total-sucursales' ),
				'locating'    => __( 'Obteniendo tu ubicación…', 'total-sucursales' ),
				'error'       => __( 'No pudimos obtener tu ubicación.', 'total-sucursales' ),
				'pickup'      => TS_Settings::get( 'pickup_label' ),
				'national'    => __( 'Envío nacional', 'total-sucursales' ),
				'unknown'     => __( 'distancia no disponible', 'total-sucursales' ),
				'no_position' => __( 'No conocemos tu posición: comparte tu ubicación o completa la dirección para evaluar el retiro en tienda.', 'total-sucursales' ),
			),
		);
	}
